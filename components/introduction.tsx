...
const Introduction = () => {
    ...
    return (
        <section
            id="home"
            className="min-h-screen flex flex-col justify-center items-center relative pt-16 bg-background dark:bg-background-dark"
        >
            ...
            >
                ...
                >
                    ...
                    <Link className={buttonVariants({ variant: 'secondary' })} href="/CVMiguelCimildoro2026E.pdf" target="_blank">
                        <Paperclip className="mr-2" />
                        {t.descIntro.buttonCV}
                    </Link>
                </motion.div>
            </motion.div>
            ...
            >
                <a href="#about" className="flex flex-col items-center text-foreground/70 hover:text-foreground transition-colors">
